...
class AHU(Base):
	...
	_AHUNumber = Column('AHUNumber', Integer(10), primary_key = True)
...
class Filter(Base):
	...
	_filterNumber = Column('FilterNumber', String(255), primary_key = True)
	...
	_filterReadings = relationship("Filter", back_populates="_filterNumber")
...
class FilterReading(Base):
	...
	_filterNumber = Column('FilterNumber', Integer(10), primary_key = True)
	...
	def __init__(self, timestamp, filterNumber, filterType, differencePressure):
